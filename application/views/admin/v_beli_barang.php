...
<head>
    ...
    <title>Pembelian Barang Modal</title>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Data
                    <small>Pembelian Modal Barang</small>
                    <div class="pull-right"><a href="<?php echo base_url() . 'admin/pembelian/tambah_beli' ?>" class="btn btn-sm btn-success"><span class="fa fa-plus"></span> Tambah Pembelian</a></div>
                </h1>
            </div>
        </div>
        <!-- /.row -->
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $id; ?></td>
                                <td><?php echo $nm; ?></td>
                                <td style="text-align:right;"><?php echo number_format($beli); ?></td>
