 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
     <div class="container">
         ...
         <div class="navbar-header">
             ...
             <a class="navbar-brand" href="<?php echo base_url() . 'welcome' ?>">Kasir Nufarozan Mart</a>
         </div>
                 ...
                 <?php if ($h == '1' OR $h == '0') { ?>
                     ...
                     <li class="dropdown">
                         ...
                         <ul class="dropdown-menu">
                             ...
                             <li><a href="<?php echo base_url() . 'admin/penjualan_grosir' ?>"><span class="fa fa-shopping-bag" aria-hidden="true"></span> Penjualan Grosir</a></li>
                         </ul>
                     </li>
                     <!--ending dropdown-->
                     <li>
                     ...
                     <li>
                         <a href="<?php echo base_url() . 'admin/opname' ?>"><span class="fa fa-file"></span> Stok Opname</a>
                     </li>
                     <li>
                         <a href="<?php echo base_url() . 'admin/barang/index_tambah_barang' ?>"><span class="fa fa-file"></span> Tambah Barang</a>
                     </li>
                 <?php } ?>
                 <?php if ($h == '2') { ?>
                     <!--dropdown-->
