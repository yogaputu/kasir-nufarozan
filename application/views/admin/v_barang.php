        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Data
                    ...
                    <div class="pull-right"><a href="<?php echo base_url() . 'admin/barang/c_harga_semua' ?>" class="btn btn-sm btn btn-info"><span class="fa fa-print"></span> Cetak Harga Semua</a></div>
                </h1>
            </div>
        </div>
        <!-- /.row -->
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="text-align:center;"><?php echo $min_beli; ?></td>
                                <td style="text-align:center;"><?php echo $min_harga; ?></td>
                                <td><?php echo $kat_nama; ?></td>
                                <td><a class="btn btn-xs btn btn-info" href="<?php echo base_url() . 'admin/barang/c_harga' ?>/<?php echo $id ?>"><span class="fa fa-print"></span> Cetak</a></td>
                                <td style="text-align:center;">
                                    <a class="btn btn-xs btn-warning" href="<?php echo base_url() . 'admin/barang/index_edit_barang' ?>/<?php echo $id ?>" title="Edit"><span class="fa fa-edit"></span> Edit</a>
                                    <a></a>
                                    <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/barang/hapus_barang' ?>" onsubmit="return confirm('Yakin Hapus?');">
